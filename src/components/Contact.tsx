    ...
    <section id="contact" ref={ref} className="py-20 bg-gray-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          >
            <Card className="border-gray-800 bg-gray-950/50 backdrop-blur-sm hover:border-red-500/50 transition-all duration-300 h-full">
              <CardHeader>
            ...
            <Card className="border-gray-800 bg-gray-950/50 backdrop-blur-sm hover:border-red-500/50 transition-all duration-300 h-full">
              ...
              <CardContent className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <div className="text-white group-hover:text-red-400 transition-colors">(347) 217-0008</div>
                ...
                >
                  ...
                  <div>
                    <div className="text-white">info@primedrive.com</div>
