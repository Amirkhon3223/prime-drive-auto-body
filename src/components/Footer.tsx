        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="relative">
                ...
                <div className="relative w-12 h-12 bg-gradient-to-br from-red-600 to-red-800 rounded-lg flex items-center justify-center border border-red-500/50 overflow-hidden">
            ...
            <div className="flex gap-3 mt-6">
              {[Facebook, Instagram, Youtube].map((Icon, i) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-lg bg-gray-900 border border-gray-800 hover:border-red-500/50 flex items-center justify-center hover:bg-gray-800 transition-all duration-300 group"
                >
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              ...
              >
                <div className="w-8 h-8 rounded-lg bg-gray-900 border border-gray-800 group-hover:border-red-500/50 flex items-center justify-center flex-shrink-0 transition-all duration-300">
