        ...
        <section ref={ref} className="pt-20 relative overflow-hidden">
            <div className="relative h-[100vh] bg-gray-950">
                <motion.div style={{ y }} className="absolute inset-0">
                    ...
                    />
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-gray-950 via-gray-950/95 to-gray-950/70"></div>
                    <div
                        className="absolute inset-0 bg-gradient-to-t from-gray-950 via-transparent to-transparent"></div>
                </motion.div>
                    ...
                    car
                                ...
                                >
                                    <div className="flex items-center gap-3 group">
                                        <div
                                            className="w-10 h-10 rounded-lg bg-red-500/10 border border-red-500/30 flex items-center justify-center group-hover:bg-red-500/20 transition-colors">
                            ...
                            >
                                <div className="relative">
                                    <div
                                        className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-600 rounded-2xl blur-2xl opacity-30"></div>
                                    <ImageWithFallback
                                        src={shopImage}
