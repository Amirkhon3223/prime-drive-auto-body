  ...
  return (
    <section id="pricing" ref={ref} className="py-20 bg-gray-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
                ...
                <CardContent className="relative">
                  <ul className="space-y-3 mb-6">
                    {tier.features.map((feature, i) => (
                      ...
                      >
                        <div className={`mt-0.5 w-5 h-5 rounded-full bg-gradient-to-br ${tier.color} flex items-center justify-center flex-shrink-0`}>
        ...
        >
          <div className="inline-block bg-gray-950/50 backdrop-blur-sm border border-gray-800 rounded-lg px-6 py-4">
