...
import { Paintbrush, Wrench, Zap, Car, Sparkles, Gauge } from "lucide-react";
  ...
  return (
    <section id="services" ref={ref} className="py-20 bg-gray-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <Card className="border-gray-800 bg-gray-900/50 backdrop-blur-sm hover:bg-gray-900/80 transition-all duration-300 group relative overflow-hidden">
                  ...
                  <CardHeader>
                    ...
                    >
                      <div className={`absolute inset-0 bg-gradient-to-br ${service.color} blur-xl opacity-50 rounded-lg`}></div>
                      <div className={`relative w-14 h-14 bg-gradient-to-br ${service.color} rounded-lg flex items-center justify-center border border-${service.glow}-500/30`}>
        ...
        >
          <div className="inline-flex items-center gap-4 bg-gray-900/50 backdrop-blur-sm border border-red-500/30 rounded-full px-8 py-4">
            <div className="flex -space-x-2">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-red-500 to-red-600 border-2 border-gray-900 flex items-center justify-center text-white text-sm">
                15+
              </div>
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 border-2 border-gray-900 flex items-center justify-center text-white text-sm">
                ✓
              </div>
            </div>
